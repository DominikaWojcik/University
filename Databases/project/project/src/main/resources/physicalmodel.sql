...
SELECT zarejestruj_uzytkownika('Jaroslaw','Dzikowski','Szczytnicka 39/5','50-382','Wroclaw','Polska',
    'jarekdzikowski1337@gmail.com','+48792247908', '1234');
SELECT zarejestruj_uzytkownika('Admin','Nazwisko','Adres','1337','Wroclaw','Polska',
    '1@gmail.com','1', '1');
UPDATE uzytkownik SET rodzaj = 'serwisant' WHERE telefon  = '1';
